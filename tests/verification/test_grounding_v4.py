...
try:
    ...
    # Wir testen die IDs, die laut Doku für Vertex AI stabil sein sollten
    # "gemini-2.0-flash-001" ist das neueste stabile
    # "gemini-1.5-pro-002" ist das aktuellste 1.5 Pro
    models_to_check = [
