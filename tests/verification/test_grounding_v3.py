...
try:
    ...
    # User fragt nach "Gemini 2.5 Pro". 
    # Wenn "2.5" existiert, nutzen wir es. Sonst "1.5-pro" oder "2.0-flash-exp".
    models_to_check = [
        "gemini-2.5-pro",
    ...
    for model_name in models_to_check:
        ...
        try:
            ...
            # Wenn wir hier sind, ist das Modell verfügbar.
            ...
            if "404" in msg:
                 ...
                 print(f"🚫 {model_name} PERMISSION DENIED (403) - Check Service Account")
                 # Wir probieren das nächste, falls es nur an der Modell-Berechtigung liegt
            else:
